...
public class TestQuad9 {
    ...
    private static final TestQuad9 instance = new TestQuad9();
    final static String QUAD9SERVER = "on.quad9.net";
    final static List<String> REQUIREDCIPHER = Arrays.asList("TLS_AES_128_GCM_SHA256", "TLS_AES_256_GCM_SHA384", "TLS_CHACHA20_POLY1305_SHA256");
